...
declare class Layout extends Element {
  ...
  constructor({ style }: { style?: IStyle; name?: string });
   ...
   */
  clear(options?: { removeTicker?: boolean }): void;
  clearPool(): void;
  /**
